...
class TestAddGroup(unittest.TestCase):
    ...
    def init_contact_creation(self, wd):
        ...
        wd.find_element_by_name("firstname").send_keys("First Contact")
        wd.find_element_by_name("middlename").click()
        wd.find_element_by_name("middlename").clear()
        wd.find_element_by_name("middlename").send_keys("Middle Name")
        wd.find_element_by_name("lastname").click()
        wd.find_element_by_name("lastname").clear()
        wd.find_element_by_name("lastname").send_keys("Last Name 1")
        ...
        wd.find_element_by_name("fax").send_keys("111444555")
        ...
        wd.find_element_by_name("phone2").send_keys("home1")
